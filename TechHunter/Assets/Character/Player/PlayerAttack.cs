...
public class PlayerAttack : MonoBehaviour
{
    ...
    float AttackMathf() 
    {
        ...
        {
             AttackAll = (weapondata.Attack + controller.ATK + controller.AddATK + controller.playerBuff.Attack_AllBuff) * controller.AddMultiplierATK * controller.playerBuff.MultiplyAttack_AllBuff;
        }
        else 
        {
            Debug.Log("CriticalII");
            AttackAll = ((weapondata.Attack + controller.ATK + controller.AddATK + controller.playerBuff.Attack_AllBuff) * controller.AddMultiplierATK * controller.playerBuff.MultiplyAttack_AllBuff) *3;
        }
