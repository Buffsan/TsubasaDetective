    ...
    private void FixedUpdate()
    {
        ...
        if (phase == 0)
        {
            if (AttackCount > 0.15)
            {
                ...
                AttackPool.Instance.Get(Attacks[0], transform.position, Quaternion.identity, 0.15f);
        ...
        if (phase == 1)
        {
            if (AttackCount > 1)
            {
                AttackPool.Instance.Get(Attacks[1], transform.position, Quaternion.identity, 0.1f);
        ...
        if (phase == 2)
        {
            ...
            {
                AttackCount1 = 0;
                AttackPool.Instance.Get(Attacks[2],transform.position, Quaternion.identity, 0.1f);
