...
public class BonusAttack : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        GameObject CL_Attack = Instantiate(AttackObject,other.transform.position,Quaternion.identity);//9
        EffectPool.Instance.Get(Effect, other.transform.position, Quaternion.identity, AttackDellTime, other.transform);
