...
public class StagePageManager : MonoBehaviour
{
    ...
    public TextMeshProUGUI BossMAXHP;
    [Space]
    ...
    public Sprite Star;
    public List<Image> StageDifficultyStar = new List<Image>();
    public List<Image> BossDifficultyStar = new List<Image>();
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0) && Totch && !DontTotch)
        {
            ...
            DontTotch = true;
            //Debug.Log("選択完了");
            SkillController.ChoiceStagePage();
        }
    }
