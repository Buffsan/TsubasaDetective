...
public class SkillPageManager : MonoBehaviour
{
    ...
    public GameObject SkillChangeTexts;
    ...
    public void OnPointerEnter(BaseEventData eventData)
    {
        ...
        Totch = true;
        audio.PlaySE(Clip1);
        if (ALL_SystemManager.Instance.skillController.Max_skillCount >= 5 && !LevelUp) 
        {
            SkillChangeTexts.SetActive(true);
        }
    }
    public void OnPointerExit(BaseEventData eventData)
    {
        ...
        Totch = false;
        SkillChangeTexts.SetActive(false);
    }
}
